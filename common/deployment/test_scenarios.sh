...
declare -A test_scenario15=(
    ...
    [description]="Obtain an access token using the OAuth 2.0 authorization code grant type as a Sub org user."
    [jmx]="oidc/OIDC_AuthCode_Redirect_WithConsent-sub-org.jmx"
    [tenantMode]=false
    [skip]=false
    [modes]="FULL QUICK PUBLISH"
)
