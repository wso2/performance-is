...
declare -A test_scenario3=(
    [name]="03-oidc_auth_code_redirect_with_consent_retrieve_user_attributes"
...
declare -A test_scenario04=(
    [name]="04-oidc_auth_code_redirect_with_consent_retrieve_user_attributes_and_groups"
...
declare -A test_scenario05=(
    [name]="05-oidc_auth_code_redirect_with_consent_retrieve_user_attributes_groups_and_roles"
...
declare -A test_scenario06=(
    [name]="06-oidc_auth_code_redirect_without_consent"
...
declare -A test_scenario07=(
    [name]="07-oidc_auth_code_redirect_without_consent_retrieve_user_attributes"
...
declare -A test_scenario08=(
    [name]="08-oidc_auth_code_redirect_without_consent_retrieve_user_attributes_and_groups"
...
declare -A test_scenario09=(
    [name]="09-oidc_auth_code_redirect_without_consent_retrieve_user_attributes_groups_and_roles"
...
declare -A test_scenario11=(
    [name]="11-oidc_password_grant_retrieve_user_attributes"
...
declare -A test_scenario12=(
    [name]="12-oidc_password_grant_retrieve_user_attributes_and_groups"
...
declare -A test_scenario13=(
    [name]="13-oidc_password_grant_retrieve_user_attributes_groups_and_roles"
...
declare -A test_scenario14=(
    [name]="14-saml2_sso_redirect_binding"
