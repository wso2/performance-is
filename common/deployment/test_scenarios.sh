...
declare -A test_scenario2=(
    [name]="02-oidc_auth_code_redirect_without_consent"
...
declare -A test_scenario5=(
    [name]="05-saml2_sso_redirect_binding"
...
declare -A test_scenario6=(
    [name]="06-oidc_auth_code_redirect_without_consent_retrieve_user_attributes_groups_and_roles"
...
# Test scenarions not publishing
...
declare -A test_scenario9=(
    [name]="09-oidc_auth_code_redirect_with_consent_retrieve_user_attributes"
...
declare -A test_scenario10=(
    [name]="10-oidc_auth_code_redirect_with_consent_retrieve_user_attributes_and_groups"
...
declare -A test_scenario11=(
    [name]="11-oidc_auth_code_redirect_with_consent_retrieve_user_attributes_groups_and_roles"
...
declare -A test_scenario12=(
    [name]="12-oidc_password_grant_retrieve_user_attributes"
...
declare -A test_scenario13=(
    [name]="13-oidc_password_grant_retrieve_user_attributes_and_groups"
...
declare -A test_scenario14=(
    [name]="14-oidc_password_grant_retrieve_user_attributes_groups_and_roles"
